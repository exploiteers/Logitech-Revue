...
struct xfrm_tmpl;
extern int km_query(struct xfrm_state *x, struct xfrm_tmpl *t, struct xfrm_policy *pol, int dir);
...
#ifdef CONFIG_XFRM_ENHANCEMENT
	int			(*post_reject)(struct xfrm_state *, struct sk_buff *skb, struct flowi *);
#endif
