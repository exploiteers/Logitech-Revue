...
typedef enum {
	/* BT656 - 8 bit data bus */
	INTERFACE_TYPE_BT656 = 1,
	/* BT1120 - 16 bit data bus */
	INTERFACE_TYPE_BT1120 = 2,
	/* Raw Bayer interface 8 - 16 bit */
	INTERFACE_TYPE_RAW = 4,
	/* Separate Sync interface with 8 bit data */
	INTERFACE_TYPE_YCBCR_SYNC_8 = 8,
	/* Separate Sync interface with 16 bit data */
	INTERFACE_TYPE_YCBCR_SYNC_16 = 16,
	/* 10 bit BT656 */
	INTERFACE_TYPE_BT656_10BIT = 32
...
struct standard_ops {
	int count;
	/* Indicates number of standards supported */
	int (*enumstd) (struct v4l2_standard *argp, void *dec);
	/* Pointer to function to enumerate standard */
	int (*querystd) (v4l2_std_id *argp, void *dec);
	/* Pointer to function to query standard */
	int (*setstd) (v4l2_std_id *argp, void *dec);
	/* Pointer to function to set standard */
	int (*getstd) (v4l2_std_id *argp, void *dec);
	/* Pointer to function to get standard */
};

/* format ops structure */
struct format_ops {
	int count;
	/* Indicats number of formats supported */
	int (*enumformat) (struct v4l2_fmtdesc *argp, void *dec);
	/* Pointer to function to enumerate formats */
	int (*tryformat) (struct v4l2_format *argp, void *dec);
	/* Pointer to function to try format */
	int (*setformat) (struct v4l2_format *argp, void *dec);
	/* Pointer to function to set formats */
	int (*getformat) (struct v4l2_format *argp, void *dec);
	/* Pointer to function to get formats */
};

/* control ops structure */
struct control_ops {
	int count;
	/* Indicats number of controls supported */
	int (*queryctrl) (struct v4l2_queryctrl *argp, void *dec);
	/* Pointer to function to enumerate controls */
	int (*setcontrol) (struct v4l2_control *argp, void *dec);
	/* Pointer to function to set controls */
	int (*getcontrol) (struct v4l2_control *argp, void *dec);
	/* Pointer to function to get controls */
};

/* input ops structure */
struct input_ops {
	int count;
	/* Indicats number of inputs supported */
	int (*enuminput) (struct v4l2_input *argp, void *dec);
	/* Pointer to function to query inputs */
	int (*setinput) (int *argp, void *dec);
	/* Pointer to function to set inputs */
	int (*getinput) (int *argp, void *dec);
	/* Pointer to function to get inputs */
};
...
struct decoder_device {
	...
	/* This function will be called whenever the sliced vbi data
	   has to be get from the decoder */
	int (*get_sliced_vbi_cap) (struct v4l2_sliced_vbi_cap *cap, void *dec);
	/* This function will be called whenver all the sliced vbi services
	needs to be get from the decoder */
};
