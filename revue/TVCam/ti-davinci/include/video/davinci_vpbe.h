...
/* adv:cdc added field definitions for the YCCCTL register */
#define VENC_YCCCTL_CHM_SHIFT           4
#define VENC_YCCCTL_CHM             (1 << 4)
#define VENC_YCCCTL_YCP_SHIFT           2
#define VENC_YCCCTL_YCP             (3 << 2)
#define VENC_YCCCTL_YCP_YCC16_CbCr  (0 << 2)
#define VENC_YCCCTL_YCP_YCC16_CrCb  (1 << 2)
#define VENC_YCCCTL_YCP_YCC8_CbYCrY (0 << 2)
#define VENC_YCCCTL_YCP_YCC8_YCrYCb (1 << 2)
#define VENC_YCCCTL_YCP_YCC8_CrYCbY (2 << 2)
#define VENC_YCCCTL_YCP_YCC8_YCbYCr (3 << 2)
#define VENC_YCCCTL_FID656_SHIFT        1
#define VENC_YCCCTL_FID656          (1 << 1)
#define VENC_YCCCTL_R656_SHIFT          0
#define VENC_YCCCTL_R656            (1 << 0)
