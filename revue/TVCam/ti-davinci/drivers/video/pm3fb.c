 ...
 *  more details.
 *
 *  $Header: pm3fb.c: Revision: 1: Author: LLUO: Date: Sunday, February 28, 2010 11:40:51 PM$
 *
 *  CHANGELOG:
...
int __init pm3fb_init(void)
{
	...
	DPRINTK(2, "This is pm3fb.c, CVS version: $Header: pm3fb.c: Revision: 1: Author: LLUO: Date: Sunday, February 28, 2010 11:40:51 PM$");
