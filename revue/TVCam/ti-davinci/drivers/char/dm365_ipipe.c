...
#include <asm/arch/dm365_ipipe_hw.h>
...
static int ipipe_set_hw_if_param(struct ccdc_hw_if_param *if_param);
...
int ipipe_set_hw_if_param(struct ccdc_hw_if_param *if_param)
{
	int ret;
	struct ipipe_params *param = oper_state.shared_config_param;
