...
int sock_sendmsg(struct socket *sock, struct msghdr *msg, size_t size)
{
	...
	MARK(net_socket_sendmsg, "struct socket %p %zu", sock, size);
		 ...
		 size_t size, int flags)
{
	...
	MARK(net_socket_recvmsg, "struct socket %p %zu", sock, size);
...
asmlinkage long sys_socket(int family, int type, int protocol)
{
	...
	MARK(net_socket_create, "struct socket %p %d", sock, retval);
