...
ltt_facility_t	ltt_facility_kernel_arch_93C7DAA1;

#define LTT_FACILITY_SYMBOL		ltt_facility_kernel_arch
#define LTT_FACILITY_CHECKSUM_SYMBOL	ltt_facility_kernel_arch_93C7DAA1
#define LTT_FACILITY_CHECKSUM		0x93C7DAA1
