...
// FIXME RT. this code is a mess. the extra +1 is needed for 2048 bit
// keys. Really it should parse the packet header correctly!
#define DSI_PKEY_N_OFFSET        8 + 1         /* offset for pkey->n */
