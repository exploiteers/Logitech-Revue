...
#define MAX_NODELAY_BUS_NAME_SIZE 20
static char nodelay_bus_name[MAX_NODELAY_BUS_NAME_SIZE];
module_param_string(nodelay_bus_name, nodelay_bus_name, MAX_NODELAY_BUS_NAME_SIZE, S_IRUGO | S_IWUSR);
MODULE_PARM_DESC(nodelay_bus_name, "Do not delay before using devices on this bus");
...
static int usb_stor_scan_thread(void * __us)
{
	...
	if (delay_use > 0 && strcmp(us->pusb_dev->bus->bus_name, nodelay_bus_name) && 0) {
