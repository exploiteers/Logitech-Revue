...
/* V4L2 interface */
extern const struct file_operations uvc_fops;
...
/* GoogleTV: these functions are located in asm/unaligned.h in future kernels.
   Copy them here to avoid conflicts with other 2.6.23 drivers that define
   these functions locally (e.g. ALSA) */
