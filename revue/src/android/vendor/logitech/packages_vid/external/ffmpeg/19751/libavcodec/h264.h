...
typedef struct MacroBlock
{
    ...
    int Y_width;
    int Y_height;
    int8_t Y_nonzero[4][4]; ///< y,x
    int8_t U_nonzero[2][2];
    int8_t V_nonzero[2][2];
...
#define PART_NOT_AVAILABLE -2
    ...
    int bufsize;
    int frame_counter;
    int idr_pic_id; ///< Identifies an IDR picture; shall be in the range [0,65535] inclusive
    int max_frame_num;
    int log2_max_frame_num_minus4; ///< Specifies max_frame_num; shall be in the range [0,12] inclusive
