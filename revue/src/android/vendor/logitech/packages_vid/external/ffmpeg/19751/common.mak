...
#$(BUILD_ROOT_REL)/version.h: $(BUILD_ROOT_REL)/version.sh
...
CLEANSUFFIXES     = *.o *~ *.ho *.map *.rco
DISTCLEANSUFFIXES = *.d *.pc
LIBSUFFIXES       = *.a *.lib *.so *.so.* *.dylib *.dll *.def *.dll.a *.exp *.aps
