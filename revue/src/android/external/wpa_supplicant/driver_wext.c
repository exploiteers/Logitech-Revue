	...
	while (pos + IW_EV_LCP_LEN <= end) {
		...
		case IWEVQUAL:
			if (ap_num < max_size) {
				...
				// GoogleTV: negative value expected. See discussion:
				// http://groups.google.com/group/android-porting/browse_thread/thread/ecd75f00368be016/3f93a9c1026199a6?#3f93a9c1026199a6
