...
/*
 * johngro@google.com - This os_sleep symbol conflicts with a symbol in the
 * Intel CE3100 SDK.  When a library (like a gstreamer plugin library) is loaded
 * completely dynamically (IOW - using dlopen instead of being linked against a
 * process), that library will end up using this os_sleep instead of the
 * os_sleep it should be using.  Because of this, we rename this os_sleep to
 * avoid the conflict.
 */
#define os_sleep wpa_os_sleep
