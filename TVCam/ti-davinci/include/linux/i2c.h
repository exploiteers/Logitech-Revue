...
// no impelementation in i2c-core.c
/*
...
// smbus implemented in i2c-core.c too
...
#define I2C_OWN_ADDRESS	0x0709	/* Set I2C chip own address for slave mode operation */
#define I2C_SLAVE_MODE	0x070A	/* Set I2C chip in slave mode operation */
#define I2C_SLAVE_CALLBACK 0x070B 
                                /* Set callback function to process reveive and transmit data */
