...
#define IPIPE_BASE_ADDR 		0x01C70800
#define RSZ_BASE_ADDR			0x01C70400
#define IPIPE_INT_TABLE_BASE_ADDR	0x01C70000
...
/* Macro for resizer */
#define IPIPE_RESIZER_A(i)  (RSZ_BASE_ADDR + RSZ_EN_A + i)
#define IPIPE_RESIZER_B(i)  (RSZ_BASE_ADDR + RSZ_EN_B + i)
...
{
	return davinci_readl(IPIPE_BASE_ADDR + offset);
}

static inline u32 regw_ip(u32 val, u32 offset)
{
	davinci_writel(val, IPIPE_BASE_ADDR + offset);
	return val;
}

static inline u32 r_ip_table(u32 offset)
{
	return davinci_readl(IPIPE_INT_TABLE_BASE_ADDR + offset);
}

static inline u32 w_ip_table(u32 val, u32 offset)
{
	davinci_writel(val, IPIPE_INT_TABLE_BASE_ADDR + offset);
	return val;
}

static inline u32 regr_rsz(u32 offset)
{
	return davinci_readl(RSZ_BASE_ADDR + offset);
}

static inline u32 regw_rsz(u32 val, u32 offset)
{
	davinci_writel(val, RSZ_BASE_ADDR + offset);
	return val;
}
