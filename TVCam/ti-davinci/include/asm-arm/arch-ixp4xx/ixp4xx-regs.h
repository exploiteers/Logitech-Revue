 ...
 *
 * 0xCD000000	0x01000000	ioremap'd	USB2 Host Controller 1
 *
 * 0xCE000000	0x01000000	ioremap'd	USB2 Host Controller 2
 */
...
/*
 * USB2 Host Controller 1/2
 */
#define IXP4XX_USB_HOST1_BASE_PHYS	(0xCD000000)
#define IXP4XX_USB_HOST1_REGION_SIZE	(0x00000200)

#define IXP4XX_USB_HOST2_BASE_PHYS	(0xCE000000)
#define IXP4XX_USB_HOST2_REGION_SIZE	(0x00000200)
