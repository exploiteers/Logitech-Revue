...
#define REALVIEW_SYS_LOCKVAL_MASK	0xA05F		/* write 0xA05F to enable write access */
#define REALVIEW_SYS_LOCKVAL_RSTCTL	0x0100		/* Control register SYS_RESETCTL is set to 1 to force a soft reset */
...
#define INT_CORE_PMU_IRQ		(32 + 7)	/* PMU IRQ */
