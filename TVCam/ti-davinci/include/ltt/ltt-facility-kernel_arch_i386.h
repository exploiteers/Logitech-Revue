...
enum lttng_syscall_name {
	...
	LTTNG_pivot_root = 217,
	LTTNG_mincore = 218,
	LTTNG_madvise = 219,
	LTTNG_madvise1 = 219,
	LTTNG_getdents64 = 220,
	LTTNG_fcntl64 = 221,
	LTTNG_gettid = 224,
	LTTNG_readahead = 225,
	LTTNG_setxattr = 226,
	...
	LTTNG_set_thread_area = 243,
	LTTNG_get_thread_area = 244,
	LTTNG_io_setup = 245,
	LTTNG_io_destroy = 246,
	LTTNG_io_getevents = 247,
	LTTNG_io_submit = 248,
	LTTNG_io_cancel = 249,
	LTTNG_fadvise64 = 250,
	LTTNG_set_zone_reclaim = 251,
	LTTNG_exit_group = 252,
	LTTNG_lookup_dcookie = 253,
	LTTNG_epoll_create = 254,
	LTTNG_epoll_ctl = 255,
	LTTNG_epoll_wait = 256,
	LTTNG_remap_file_pages = 257,
	LTTNG_set_tid_address = 258,
	LTTNG_timer_create = 259,
	LTTNG_timer_settime = 260,
	LTTNG_timer_gettime = 261,
	LTTNG_timer_getoverrun = 262,
	LTTNG_timer_delete = 263,
	LTTNG_clock_settime = 264,
	LTTNG_clock_gettime = 265,
	LTTNG_clock_getres = 266,
	LTTNG_clock_nanosleep = 267,
	LTTNG_statfs64 = 268,
	LTTNG_fstatfs64 = 269,
	LTTNG_tgkill = 270,
	LTTNG_utimes = 271,
	LTTNG_fadvise64_64 = 272,
	LTTNG_vserver = 273,
	LTTNG_mbind = 274,
	LTTNG_get_mempolicy = 275,
	LTTNG_set_mempolicy = 276,
	LTTNG_mq_open = 277,
	LTTNG_mq_unlink = 278,
	LTTNG_mq_timedsend = 279,
	LTTNG_mq_timedreceive = 280,
	LTTNG_mq_notify = 281,
	LTTNG_mq_getsetattr = 282,
	LTTNG_sys_kexec_load = 283,
	LTTNG_waitid = 284,
	LTTNG_add_key = 286,
	LTTNG_request_key = 287,
	LTTNG_keyctl = 288,
	LTTNG_ioprio_set = 289,
	LTTNG_ioprio_get = 290,
	LTTNG_inotify_init = 291,
	LTTNG_inotify_add_watch = 292,
	LTTNG_inotify_rm_watch = 293,
	LTTNG_migrate_pages = 294,
	LTTNG_openat = 295,
	LTTNG_mkdirat = 296,
	LTTNG_mknodat = 297,
	LTTNG_fchownat = 298,
	...
	LTTNG_linkat = 303,
	LTTNG_symlinkat = 304,
	LTTNG_readlinkat = 305,
	LTTNG_fchmodat = 306,
	LTTNG_faccessat = 307,
	LTTNG_pselect6 = 308,
	LTTNG_ppoll = 309,
	LTTNG_unshare = 310,
	LTTNG_set_robust_list = 311,
	LTTNG_get_robust_list = 312,
	LTTNG_splice = 313,
	LTTNG_sync_file_range = 314,
	LTTNG_tee = 315,
	LTTNG_vmsplice = 316,
	LTTNG_move_pages = 317,
	LTTNG_ltt_trace_generic = 318,
	LTTNG_ltt_register_generic = 319,
};
	...
	list_for_each_entry_rcu(trace, &ltt_traces.head, list) {
		...
		*to_base = *to = *len = 0;
		...
		ltt_write_event_header(trace, channel, buffer,
			ltt_facility_kernel_arch_7150A865, event_kernel_arch_syscall_entry,
		...
		void)
{
	...
	list_for_each_entry_rcu(trace, &ltt_traces.head, list) {
		...
		*to_base = *to = *len = 0;
		...
		ltt_write_event_header(trace, channel, buffer,
			ltt_facility_kernel_arch_7150A865, event_kernel_arch_syscall_exit,
			reserve_size, before_hdr_pad, tsc);
		*to_base += before_hdr_pad + after_hdr_pad + header_size;
