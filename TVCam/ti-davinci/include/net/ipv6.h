...
/* debug */
#ifdef CONFIG_IPV6_STATISTICS_DEBUG
#define SNMP6_DEBUG_IDEV(name)						\
	printk(KERN_DEBUG "%s(): idev is NULL for %s; %s:%u\n",		\
		__FUNCTION__, name, __FILE__, __LINE__)
#else
#define SNMP6_DEBUG_IDEV(name)	do { ; } while(0)
#endif
...
#define IP6_INC_STATS(idev, field)		({			\
	...
	if (likely(_idev != NULL))					\
		...
		SNMP6_DEBUG_IDEV("IP6_INC_STATS");			\
...
#define IP6_INC_STATS_BH(idev, field)		({				\
	...
	if (likely(_idev != NULL))						\
		...
		SNMP6_DEBUG_IDEV("IP6_INC_STATS_BH");				\
...
#define IP6_INC_STATS_USER(idev, field) 	({				\
	...
	if (likely(_idev != NULL))						\
		...
		SNMP6_DEBUG_IDEV("IP6_INC_STATS_USER");				\
...
#define ICMP6_INC_STATS(idev, field)		({			\
	...
	if (likely(_idev != NULL))					\
		...
		SNMP6_DEBUG_IDEV("ICMP6_INC_STATS_USER");		\
...
#define ICMP6_INC_STATS_BH(idev, field)		({			\
	...
	if (likely(_idev != NULL))					\
		...
		SNMP6_DEBUG_IDEV("ICMP6_INC_STATS_BH");			\
...
#define ICMP6_INC_STATS_OFFSET_BH(idev, field, offset)	({			\
	...
	if (likely(_idev != NULL))						\
		...
		SNMP6_DEBUG_IDEV("ICMP6_INC_STATS_OFFSET_BH");		\
...
#define UDP6_INC_STATS(idev, field)		({			\
	...
	if (likely(_idev != NULL))					\
		...
		SNMP6_DEBUG_IDEV("UDP6_INC_STATS");			\
...
#define UDP6_INC_STATS_BH(idev, field)		({			\
	...
	if (likely(_idev != NULL))					\
		...
		SNMP6_DEBUG_IDEV("UDP6_INC_STATS_BH");			\
...
#define UDP6_INC_STATS_USER(idev, field) 	({			\
	...
	if (likely(_idev != NULL))					\
		...
		SNMP6_DEBUG_IDEV("UDP6_INC_STATS_USER");		\
...
static inline int __ipv6_prefix_equal(const __u32 *a1, const __u32 *a2,
