...
ltt_facility_t	ltt_facility_kernel_arch_842889DA;

#define LTT_FACILITY_SYMBOL		ltt_facility_kernel_arch
#define LTT_FACILITY_CHECKSUM_SYMBOL	ltt_facility_kernel_arch_842889DA
#define LTT_FACILITY_CHECKSUM		0x842889DA
