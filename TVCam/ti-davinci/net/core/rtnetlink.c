...
static const int rtm_min[RTM_NR_FAMILIES] =
{
	...
	[RTM_FAM(RTM_NEWPREFIX)]    = NLMSG_LENGTH(sizeof(struct prefixmsg)),
	[RTM_FAM(RTM_GETPREFIX)]    = NLMSG_LENGTH(sizeof(struct prefixmsg)),
...
static const int rta_max[RTM_NR_FAMILIES] =
{
	...
	[RTM_FAM(RTM_NEWPREFIX)]    = PREFIX_MAX,
	[RTM_FAM(RTM_GETPREFIX)]    = PREFIX_MAX,
