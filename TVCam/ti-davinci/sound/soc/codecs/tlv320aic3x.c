...
static int aic3x_init(struct snd_soc_device *socdev)
{
...
#ifdef	__USB_AUDIO_GAIN__ /* 30 dB for USB WebCam. Is CONFIG_MTD_DM365_NOR a good compile switch flag??? */ 
	/* ADC default volume and unmute */
	aic3x_write(codec, LADC_VOL, 0x14); // 0x76: 59dB, 0x64 : 50dB,  0x50: 40dB, 
					    // 0x3C: 30dB, 0x28: 20dB, 0x14: 10dB, 0x0C: 6dB
	aic3x_write(codec, RADC_VOL, 0x14);  // 0x76: 59dB, 0x64 : 50dB,  0x50: 40dB, 
					    // 0x3C: 30dB, 0x28: 20dB, 0x14: 10dB, 0x0C: 6dB
#else /* 10 dB for D1 */
	/* ADC default volume and unmute */
	aic3x_write(codec, LADC_VOL, 0x14); // 0x76: 59dB, 0x64 : 50dB,	0x50: 40dB, 
	...
	/* Enable AGC */
	aic3x_write(codec, LAGC_CTRL_A, 0x00); // disable AGC, 0x80 to enable
	aic3x_write(codec, LAGC_CTRL_B, 0x00); // 0x76: 59dB, 0x64 : 50dB,  0x50: 40dB, 
					    // 0x3C: 30dB, 0x28: 20dB, 0x14: 10dB, 0x0C: 6dB
	aic3x_write(codec, LAGC_CTRL_C, 0x00);
	aic3x_write(codec, RAGC_CTRL_A, 0x00);// disable AGC, 0x80 to enable
	aic3x_write(codec, RAGC_CTRL_B, 0x00);// 0x76: 59dB, 0x64 : 50dB,  0x50: 40dB, 
					    //  0x3C: 30dB, 0x28: 20dB, 0x14: 10dB, 0x0C: 6dB
	...
	aic3x_write(codec, LINE1L_2_LADC_CTRL, 0x84);
	aic3x_write(codec, LINE1R_2_LADC_CTRL, 0x80);
	aic3x_write(codec, LINE1R_2_RADC_CTRL, 0x84);
	aic3x_write(codec, LINE1L_2_RADC_CTRL, 0x80);
	...
	/*wing add for FM31 init*/
	static int i= 0;
	struct i2c_msg msg[1];
	char buf[] =   
		{0xfc,0xf3,0x3b,0x23,0x1a,0x00,0x04,
		0xfc,0xf3,0x3b,0x23,0x08,0x00,0x7f,
		0xfc,0xf3,0x3b,0x23,0x2c,0x00,0x1a,
		0xfc,0xf3,0x3b,0x23,0x0b,0x00,0x03,
		0xfc,0xf3,0x3b,0x23,0xf8,0x40,0x03,
		0xfc,0xf3,0x3b,0x23,0xf9,0x00,0x02,
		0xfc,0xf3,0x3b,0x23,0x0d,0x18,0x00,
		0xfc,0xf3,0x3b,0x23,0x0c,0x00,0x00};
	...
	if(1 != i){
		   ...
		   msg->len = 56;
		   msg->buf = buf;
	if(i2c_transfer(((struct i2c_client *)(codec->control_data))->adapter, msg,1))
		   printk("there is something in the write\n");
	}
	/*wing add for FM31 init*/
